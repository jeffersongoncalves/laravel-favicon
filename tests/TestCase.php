...
namespace JeffersonGoncalves\Favicon\Tests;
...
class TestCase extends Orchestra
{
    protected function setUp(): void
    {
        ...
        Factory::guessFactoryNamesUsing(
            fn (string $modelName) => 'JeffersonGoncalves\\Favicon\\Database\\Factories\\'.class_basename($modelName).'Factory'
        );
    ...
    public function getEnvironmentSetUp($app)
    {
        ...
        // and calling Favicon::routes() explicitly.
